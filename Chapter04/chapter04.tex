...
\chapter{Polynomials}
\begin{itemize}
    \item \marginnote{9/8:}\textbf{Real part} (of $a+bi\in\C$): The number $a$. \emph{Denoted by} $\mathbf{Re}\,\bm{z}$.
    ...
    \end{equation*}
    \item Analogously,
    \begin{theorem}[Division Algorithm for Polynomials]\label{trm:DivisionAlgorithmforPolynomials}
