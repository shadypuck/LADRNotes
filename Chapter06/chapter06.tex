...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{align*}
            ...
            \inp{u}{u}+\inp{v}{v} &= \inp{u}{u}+\inp{v}{u}+\inp{u}{v}+\inp{v}{v}\\
            0 &= \inp{u}{v}+\inp{v}{u}\\
            ...
            &= \inp{u}{v}
        \end{align*}
        where the first equality holds by the definition of the norm, the second by the additivity of the inner product and Theorem \ref{trm:inpPropertiesd}, the fifth by Theorem \ref{trm:propertiesComplex}, and the sixth by the hypothesis that the inner product space is real, as desired.
    \end{itemize}
...
\begin{enumerate}[label={\textbf{\arabic*}},labelsep=1em,ref={\thesection.\arabic*}]
    \setcounter{enumi}{18}
    \item \marginnote{10/11:}\label{exr:6A19}Suppose $V$ is a real inner product space. Prove that
    \begin{equation*}
        \inp{u}{v} = \frac{\norm{u+v}^2-\norm{u-v}^2}{4}
    \end{equation*}
    for all $u,v\in V$.
...
\begin{itemize}
    ...
    \begin{theorem}\label{trm:orthonormalExists}
    ...
    \begin{theorem}\label{trm:orthonormalExtendBasis}
    ...
    \begin{theorem}[Schur's Theorem\footnote{German mathematician Issai Schur published the first proof of this result in 1909.}]\label{trm:Schur}
...
\begin{itemize}
    ...
    \begin{theorem}\label{trm:dimPerp}
    ...
    \begin{theorem}\label{trm:perpPerp}
        Suppose $U$ is a finite-dimensional subspace of $V$. Then
        \begin{equation*}
            U = (U^\perp)^\perp
        \end{equation*}
